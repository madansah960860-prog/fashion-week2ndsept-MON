/* ==========================================================================
   SPLITSEC ATHLETIC - shared behaviour
      ...
      on(form, "submit", function (e) {
        ...
        if (status) {
          ...
          status.textContent = form.getAttribute("data-success") ||
            "Thank you. Your message has been queued for our Portland team and we reply within one business day.";
